...
GPIOA_init: //In lab7 used to initilize the 7 segment display
	...
	orrs r2, r2, r0
	str r0, [r1]
    //we dont need the GPIOB this time, use other part fot the one wire thermometer
	pop {r0,r1,r2,lr}
	BX LR

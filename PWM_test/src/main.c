...
//TODO: Initial GPIO pin as alternate function for buzzer. You can choose to use C or assembly to finish this function.
	...
	//PA5 TIM2_CH1
	GPIOA->MODER   &= 0b11111111111111111100001100000000;
	GPIOA->MODER   |= 0b00000000000000000001010001010101; //change log pa2 pa3
	GPIOA->AFR[0] &= ~GPIO_AFRL_AFSEL5_0;//AFR[0] LOW
	GPIOA->AFR[0] |= GPIO_AFRL_AFSEL5_0;//PA5
	//PA2 TIM2_CH3
	GPIOA->AFR[0] &= ~GPIO_AFRL_AFSEL2_0;//AFR[0] LOW
	GPIOA->AFR[0] |= GPIO_AFRL_AFSEL2_0;//PA2
	//PB10 TIM2_CH3
